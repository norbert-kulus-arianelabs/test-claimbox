...
>({
  approveTokenAllowance: () => Promise.resolve(false),
  ...
  calculateGasForClaim: () => Promise.resolve(undefined),
  resetGas: () => undefined,
  calculateGasWithRetry: () => Promise.resolve(undefined),
  ...
  gas: { status: "idle", amount: null },
  retriesCount: 0,
  userMintLimitExceeded: false,
});
